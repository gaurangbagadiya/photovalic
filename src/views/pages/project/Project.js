  ...
  const onSubmit = async (data) => {
    ...
    if (state && state?.project_id) {
      ...
      if (state?.type == 0) {
        ...
        let response = await updateProject(projectData);
        // console.log("respo", response);
        notification({
          type: response?.status == 1 ? "success" : "error",
          message: response.message,
        ...
        <Col xs={12}>
          ...
          <Card className="mb-5">
            <CardHeader>
              ...
              <Link to="/Info">
                <Label>
                  <strong> what should i write in the given fields?</strong>
                  <Info
                    size={15}
                    style={{
                      marginRight: "5px",
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        {...field}
                        disabled={
                          state && state?.project_id && state?.type != 2
                        }
                          ...
                          <Select
                            ...
                            value={
                              ...
                              preData?.map((s) => {
                                ...
                                if (
                                  s?.product_name == projectData?.product_name
                                ) {
